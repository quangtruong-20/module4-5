    ...
    <>
            ...
            <nav className="HeaderPC_header__q8FpX">
                <div id="header-fixed" className="HeaderPC_fixed__F0Sl1">
                    <div className="container">
                                    ...
                                    >
                                        ...
                                        <svg width={20} height={20} viewBox="0 0 20 20" fill="none">
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                                d="M9.87029 18.0516C6.79378 18.0516 4.1665 17.5728 4.1665 15.6555C4.1665 13.7382 6.77711 11.9683 9.87029 11.9683C12.9468 11.9683 15.5741 13.7211 15.5741 15.6384C15.5741 17.5549 12.9635 18.0516 9.87029 18.0516Z"
                                                stroke="#8894A7"
                                                strokeWidth="1.5"
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                            ...
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                                d="M9.86409 9.31136C11.883 9.31136 13.5194 7.675 13.5194 5.65606C13.5194 3.63712 11.883 2 9.86409 2C7.84515 2 6.20803 3.63712 6.20803 5.65606C6.20121 7.66818 7.82621 9.30455 9.83833 9.31136C9.84742 9.31136 9.85576 9.31136 9.86409 9.31136Z"
                                                stroke="#8E9AAB"
                                                strokeWidth="1.5"
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                        ...
                        <div
                            className="HeaderPC_header-body__NqyVe"
                            style={{ paddingTop: 18 }}
                        >
                            ...
                            <div className="HeaderPC_group-product__hR8Zr">
                                ...
                                <p
                                    className="HeaderPC_title__yQizO"
                                    style={{ paddingLeft: 10, paddingTop: 15 }}
                                >
                                    Danh mục
                                </p>
                                <svg
                                    className="HeaderPC_chevron-icon__Iw9ud"
                                    stroke="#112950"
                                    width={12}
                                    height={8}
                                    viewBox="0 0 12 8"
                                ...
                                >
                                    <path
                                        d="M10.6673 1.66602L6.00065 6.33268L1.33398 1.66602"
                                        stroke="#112950"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <div className="HeaderPC_search__kcNmc">
                                <form>
                                    <div className="SearchBox_search-box___lCm7">
                                        <input placeholder="Tìm theo tên thuốc" defaultValue="" />
                                        <div className="SearchBox_content__Uqi4D">
                                            <svg
                                                className="SearchBox_search-icon__vEKjT"
                                                width={20}
                                                height={20}
                                                viewBox="0 0 20 20"
                                                fill="none"
                ...
                <span>
                  <svg width={24} height={24} viewBox="0 0 24 24" fill="none">
                    ...
                    />
                    <path
                        d="M15 20C15 21.65 13.65 23 12 23C11.18 23 10.42 22.66 9.88 22.12C9.34 21.58 9 20.82 9 20"
                        stroke="white"
                        strokeWidth="1.5"
                        strokeMiterlimit={10}
                    />
                                ...
                                <div className="PaymentAndCart_wrap-cart__wEPgX">
                                    <a
                                        className="PaymentAndCart_payment-cart-container__dKlJB cursor-point"
                                        href="/cart"
                                    >
                                        <div>
                                            <p>Thanh toán</p>
                                            <p className="PaymentAndCart_total-price__sN_Ux">
                                                355.000 đ
                                            </p>
                                        </div>
                    ...
                    <span className="CartBadge_cart-badge-container__6Aapr">
                      <svg
                          className="cart-badge-container__cart-icon"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
                          fill="none"
                    ...
                    <div style={{ position: "absolute", top: 0, left: 0, width: "100%" }}>
                        <div>
                            <div
                                className="rc-dropdown Dropdown_dropdown__0iw6U rc-dropdown-show-arrow rc-dropdown-placement-bottomRight"
                                id="customer-info"
                                style={{ minWidth: 96, left: 97, top: "-964px" }}
                            >
                                <div className="rc-dropdown-arrow" />
                                <div
                                    className="MenuHead_menu-head__pM_ja"
                                    style={{
                                        marginLeft: 972,
                                        marginTop: 25,
                                        width: "17%",
        ...
        <section className="wrapper">
            <div className="login">
                <img
                    className="site-icon "
                    src="https://cdn.tgdd.vn/2022/10/banner/TGDD-540x270-2.png"
                    style={{ marginLeft: "283%" }}
                />
                <div className="d1 step1">
                    <span>Đăng nhập</span>
                    <form id="frmGetVerifyCode" onsubmit="return GetVerifyCode(0, 1);">
                        <div className="input-area">
            <span
                className="iconoh-phone-blue input-icon"
                style={{ marginTop: "-5px" }}
            >
              <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                ...
                />
                            ...
                            <input
                                ...
                                maxLength={10}
                            />
                            {/*          <input type="tel" name="txtPassword" id="txtPassword" onkeypress="ValidateOnlyNumber(event)" placeholder="Mật khẩu" autocomplete="off">*/}
                        </div>
                        <div className="input-area">
            <span className="iconpa-phone-blue input-icon">
              <svg width={16} height={18} viewBox="0 0 16 18" fill="none">
                ...
                />
                            ...
                            {/*          <input type="tel" name="txtPhoneNumber" id="txtPhoneNumber" onkeypress="ValidateOnlyNumber(event)" placeholder="Số điện thoại của bạn" autocomplete="off" maxlength="10">*/}
                            <input
                                type="tel"
                                name="txtPassword"
                                id="txtPassword"
                        ...
                        <div
                            className="LoginForm_text-forget-password__TfqIV"
                        ...
                        <div className="info_contact">
                            ...
                            <div className="box">
                                <div className="img-box">
                                    <img
                                        src="../../public/images/telephone-symbol-button.png"
                                        alt=""
                                    />
                                </div>
                            ...
                            <div className="box">
                                ...
                                <div className="detail-box">
                                    <h6>nhathuoctruongan@gmail.com</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-3">
                        <div className="info_menu">
                            ...
                            <ul className="navbar-nav  ">
                                <li className="nav-item active">
                                    <a className="nav-link" href="home.html">
                                        Nội quy nhà thuốc<span className="sr-only">(current)</span>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="about.html">
                    ...
                    <div className="col-md-3">
                        <div className="info_menu">
                            ...
                            <ul className="navbar-nav  ">
                                <li className="nav-item active">
                                    <a className="nav-link" href="home.html">
                                        Giới thiệu công ty<span className="sr-only">(current)</span>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="about.html">
